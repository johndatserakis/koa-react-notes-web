...
function App() {
  return (
    <Router>
      <div>
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad tenetur, nihil asperiores adipisci quasi nam atque! A magni blanditiis provident soluta odio modi distinctio odit, tenetur dicta? Fugit, ratione dolor.
        <Counter />
      </div>
      <hr />
